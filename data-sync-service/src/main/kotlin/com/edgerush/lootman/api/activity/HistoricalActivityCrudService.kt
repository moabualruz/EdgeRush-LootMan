...
interface HistoricalActivityCrudService : CrudService<Long, CreateHistoricalActivityRequest, UpdateHistoricalActivityRequest, HistoricalActivityResponse> {
    fun findByCharacterId(characterId: Long, pageRequest: PageRequest): PagedResponse<HistoricalActivityResponse>
    fun findByTeamId(teamId: Long, pageRequest: PageRequest): PagedResponse<HistoricalActivityResponse>
