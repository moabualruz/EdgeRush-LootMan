...
interface RaiderEntityCrudService : CrudService<Long, CreateRaiderEntityRequest, UpdateRaiderEntityRequest, RaiderEntityResponse> {
    fun findByRealm(realm: String, pageRequest: PageRequest): PagedResponse<RaiderEntityResponse>
    fun findByRegion(region: String, pageRequest: PageRequest): PagedResponse<RaiderEntityResponse>
