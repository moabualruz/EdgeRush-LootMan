...
class RaidSignupCrudServiceImpl(
    ...
    override fun existsById(id: Long): Boolean = signupRepository.existsById(id)
    ...
    override fun findSelectedByRaid(
        raidId: Long,
        pageRequest: PageRequest,
    ): PagedResponse<RaidSignupResponse> {
    ...
    override fun countByRaid(raidId: Long): Long = signupRepository.countByRaidId(raidId)
}
