...
class FlpsConfigPreviewService(
     ...
     */
    fun previewConfigChanges(guildId: String, request: ConfigPreviewRequest): ConfigPreviewResponse {
        ...
        val comparisons = raiderDataList.map { raiderData ->
            ...
            val proposedEligible = acs.value >= proposedModifiers.thresholds.eligibilityAttendance &&
        ...
        val raiderImpacts = comparisons.map { comp ->
