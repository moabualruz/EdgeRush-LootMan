...
class GuildConfigurationCrudServiceImpl(
    ...
    override fun findByGuildId(guildId: String): GuildConfigurationResponse {
        val entity = repository.findByGuildId(guildId)
    ...
    override fun create(request: CreateGuildConfigurationRequest): GuildConfigurationResponse {
        val entity = GuildConfigurationEntity(
    ...
    override fun update(id: Long, request: UpdateGuildConfigurationRequest): GuildConfigurationResponse {
    ...
    override fun updateBenchmark(id: Long, request: UpdateBenchmarkRequest): GuildConfigurationResponse {
        val existing = repository.findById(id)
            ?: throw NoSuchElementException("Guild configuration not found with id: $id")
    ...
    override fun updateSyncStatus(guildId: String, status: String, error: String?): GuildConfigurationResponse {
        val existing = repository.findByGuildId(guildId)
            ?: throw NoSuchElementException("Guild configuration not found with guild id: $guildId")
