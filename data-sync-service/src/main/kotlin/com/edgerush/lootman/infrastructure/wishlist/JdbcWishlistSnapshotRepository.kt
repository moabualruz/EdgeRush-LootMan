...
class JdbcWishlistSnapshotRepository(private val jdbcTemplate: JdbcTemplate) : WishlistSnapshotRepository {
    ...
    override fun findByRaiderId(
        ...
        jdbcTemplate.query(
            "SELECT * FROM wishlist_snapshots WHERE raider_id = ? ORDER BY synced_at DESC LIMIT ? OFFSET ?",
            rowMapper,
            raiderId,
            limit,
            offset,
    ...
    override fun findByTeamId(
        ...
        jdbcTemplate.query(
            "SELECT * FROM wishlist_snapshots WHERE team_id = ? ORDER BY synced_at DESC LIMIT ? OFFSET ?",
            rowMapper,
            teamId,
            limit,
            offset,
    ...
    override fun delete(id: Long) {
        jdbcTemplate.update("DELETE FROM wishlist_snapshots WHERE id = ?", id)
    }
