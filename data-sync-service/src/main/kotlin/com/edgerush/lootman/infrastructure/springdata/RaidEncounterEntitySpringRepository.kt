...
interface RaidEncounterEntitySpringRepository :
    ...
    fun findByRaidId(raidId: Long, pageable: Pageable): Page<RaidEncounterEntity>

    fun countByRaidId(raidId: Long): Long

    fun findByRaidId(raidId: Long): List<RaidEncounterEntity>

    fun findByEncounterId(encounterId: Long, pageable: Pageable): Page<RaidEncounterEntity>

    fun countByEncounterId(encounterId: Long): Long

    fun findByRaidIdAndEncounterId(raidId: Long, encounterId: Long): RaidEncounterEntity?

    fun deleteByRaidId(raidId: Long)

    fun findByRaidIdAndEnabledTrue(raidId: Long, pageable: Pageable): Page<RaidEncounterEntity>
