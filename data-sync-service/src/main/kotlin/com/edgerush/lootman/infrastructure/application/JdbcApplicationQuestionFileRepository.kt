...
class JdbcApplicationQuestionFileRepository(private val jdbcTemplate: JdbcTemplate) : ApplicationQuestionFileRepository {
    ...
    override fun findByApplicationId(
        ...
        jdbcTemplate.query(
            "SELECT * FROM application_question_files WHERE application_id = ? ORDER BY question_position LIMIT ? OFFSET ?",
            rowMapper,
            applicationId,
            limit,
            offset,
    ...
    override fun save(entity: ApplicationQuestionFileEntity): ApplicationQuestionFileEntity =
        if (entity.id == null) {
            insert(entity)
        } else {
            update(entity)
    ...
    override fun delete(id: Long) {
        jdbcTemplate.update("DELETE FROM application_question_files WHERE id = ?", id)
    }
    ...
    private val rowMapper =
        RowMapper { rs, _ ->
            ...
            ApplicationQuestionFileEntity(
                ...
                getIntOrNull("question_position"),
