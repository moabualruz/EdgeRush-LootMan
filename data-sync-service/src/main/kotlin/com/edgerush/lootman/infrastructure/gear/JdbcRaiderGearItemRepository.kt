...
class JdbcRaiderGearItemRepository(private val jdbcTemplate: JdbcTemplate) : RaiderGearItemRepository {
    ...
    override fun findByRaiderId(
        ...
        jdbcTemplate.query(
            "SELECT * FROM raider_gear_items WHERE raider_id = ? ORDER BY slot LIMIT ? OFFSET ?",
            rowMapper,
            raiderId,
            limit,
            offset,
    ...
    override fun findByRaiderIdAndGearSet(
        ...
        jdbcTemplate.query(
            "SELECT * FROM raider_gear_items WHERE raider_id = ? AND gear_set = ? ORDER BY slot LIMIT ? OFFSET ?",
            rowMapper,
            raiderId,
            gearSet,
            limit,
    ...
    override fun delete(id: Long) {
        jdbcTemplate.update("DELETE FROM raider_gear_items WHERE id = ?", id)
    }
