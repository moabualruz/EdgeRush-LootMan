...
interface LootAwardWishDataRepository {
    ...
    fun findAll(offset: Long, limit: Int): List<LootAwardWishDataEntity>
    fun count(): Long
    fun findByLootAwardId(lootAwardId: Long, offset: Long, limit: Int): List<LootAwardWishDataEntity>
