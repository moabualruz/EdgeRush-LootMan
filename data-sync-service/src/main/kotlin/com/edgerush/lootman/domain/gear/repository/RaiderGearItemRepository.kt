...
interface RaiderGearItemRepository {
    ...
    fun findAll(offset: Long, limit: Int): List<RaiderGearItemEntity>
    fun count(): Long
    fun findByRaiderId(raiderId: Long, offset: Long, limit: Int): List<RaiderGearItemEntity>
    fun countByRaiderId(raiderId: Long): Long
    fun findByRaiderIdAndGearSet(raiderId: Long, gearSet: String, offset: Long, limit: Int): List<RaiderGearItemEntity>
