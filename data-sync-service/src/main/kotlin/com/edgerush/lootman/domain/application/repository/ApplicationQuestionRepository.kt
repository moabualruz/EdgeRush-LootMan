...
interface ApplicationQuestionRepository {
    ...
    fun findAll(offset: Long, limit: Int): List<ApplicationQuestionEntity>
    fun count(): Long
    fun findByApplicationId(applicationId: Long, offset: Long, limit: Int): List<ApplicationQuestionEntity>
