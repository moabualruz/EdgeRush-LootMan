...
) : BaseCrudController<ApplicationQuestionFileEntity, Long, CreateApplicationQuestionFileRequest, UpdateApplicationQuestionFileRequest, ApplicationQuestionFileResponse>(
        service,
    ) {
