...
) : BaseCrudController<WarcraftLogsPerformanceEntity, Long, CreateWarcraftLogsPerformanceRequest, UpdateWarcraftLogsPerformanceRequest, WarcraftLogsPerformanceResponse>(
        service,
    ) {
