...
,
    ...
    @Transactional
    override fun create(request: CreateWarcraftLogsReportRequest, user: AuthenticatedUser): WarcraftLogsReportResponse {
    ...
    @Transactional
    override fun update(id: Long, request: UpdateWarcraftLogsReportRequest, user: AuthenticatedUser): WarcraftLogsReportResponse {
    ...
    override fun validateAccess(entity: WarcraftLogsReportEntity, user: AuthenticatedUser) {
