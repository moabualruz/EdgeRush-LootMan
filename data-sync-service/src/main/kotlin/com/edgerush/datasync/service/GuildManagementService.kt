...
class GuildManagementService(
    ...
    private fun calculateTheoreticalPerfect(flpsConfig: FlpsGuildConfig): PerfectScoreBenchmark {
        ...
        val perfectRms =
            (1.0 * flpsConfig.rmsWeights.attendance) +
                (1.0 * flpsConfig.rmsWeights.mechanical) +
                (1.0 * flpsConfig.rmsWeights.preparation)

        val perfectIpi =
            (1.0 * flpsConfig.ipiWeights.upgradeValue) +
    ...
    private fun calculateTopPerformerBenchmark(
        guildId: String,
        flpsConfig: FlpsGuildConfig,
    ...
    private fun calculateCustomBenchmark(
        guildConfig: GuildConfigurationEntity,
        flpsConfig: FlpsGuildConfig,
    ): PerfectScoreBenchmark {
