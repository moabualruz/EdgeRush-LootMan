...
,
    ...
    @Transactional
    override fun create(request: CreateTeamMetadataRequest, user: AuthenticatedUser): TeamMetadataResponse {
    ...
    @Transactional
    override fun update(id: Long, request: UpdateTeamMetadataRequest, user: AuthenticatedUser): TeamMetadataResponse {
    ...
    override fun validateAccess(entity: TeamMetadataEntity, user: AuthenticatedUser) {
