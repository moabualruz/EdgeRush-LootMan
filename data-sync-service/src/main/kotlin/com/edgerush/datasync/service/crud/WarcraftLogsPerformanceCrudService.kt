...
,
    ...
    @Transactional
    override fun create(request: CreateWarcraftLogsPerformanceRequest, user: AuthenticatedUser): WarcraftLogsPerformanceResponse {
    ...
    @Transactional
    override fun update(id: Long, request: UpdateWarcraftLogsPerformanceRequest, user: AuthenticatedUser): WarcraftLogsPerformanceResponse {
    ...
    override fun validateAccess(entity: WarcraftLogsPerformanceEntity, user: AuthenticatedUser) {
