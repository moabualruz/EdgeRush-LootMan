...
,
    ...
    @Transactional
    override fun create(request: CreatePeriodSnapshotRequest, user: AuthenticatedUser): PeriodSnapshotResponse {
    ...
    @Transactional
    override fun update(id: Long, request: UpdatePeriodSnapshotRequest, user: AuthenticatedUser): PeriodSnapshotResponse {
    ...
    override fun validateAccess(entity: PeriodSnapshotEntity, user: AuthenticatedUser) {
