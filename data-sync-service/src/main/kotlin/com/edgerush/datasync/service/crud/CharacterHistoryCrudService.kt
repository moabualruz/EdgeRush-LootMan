...
,
    ...
    @Transactional
    override fun create(request: CreateCharacterHistoryRequest, user: AuthenticatedUser): CharacterHistoryResponse {
    ...
    @Transactional
    override fun update(id: Long, request: UpdateCharacterHistoryRequest, user: AuthenticatedUser): CharacterHistoryResponse {
    ...
    override fun validateAccess(entity: CharacterHistoryEntity, user: AuthenticatedUser) {
