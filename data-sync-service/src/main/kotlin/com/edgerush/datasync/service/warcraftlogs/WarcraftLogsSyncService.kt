...
class WarcraftLogsSyncService(
    ...
    suspend fun syncReportsForGuild(guildId: String): SyncResult {
        ...
        try {
            ...
            val reports = client.fetchReportsForGuild(
    ...
    private suspend fun processReport(
        ...
        val reportEntity = WarcraftLogsReportEntity(
            guildId = guildId,
    ...
    private suspend fun processFight(
        ...
        // Save fight entity
        val fightEntity = WarcraftLogsFightEntity(
            reportId = reportId,
            fightId = fight.id,
        ...
        val performanceRecords = extractPerformanceMetrics(
    ...
    private suspend fun extractPerformanceMetrics(
        ...
        try {
            ...
            mappings.forEach { mapping ->
                try {
                    val performance = client.fetchCharacterPerformance(
                        reportCode = reportCode,
                        fightId = fightId,
                    ...
                    if (performance != null) {
                        val avoidablePercentage = if (performance.damageTaken > 0) {
                            (performance.avoidableDamageTaken.toDouble() / performance.damageTaken.toDouble()) * 100.0
                        } else {
                            0.0
                        }
                        
                        val performanceEntity = WarcraftLogsPerformanceEntity(
    ...
    suspend fun calculateSpecAverages(
        ...
        try {
            ...
            val dpaValues = performanceData.map { 
