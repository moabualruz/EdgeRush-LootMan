...
,
    ...
    @Transactional
    override fun create(request: CreateRaiderRaidProgressRequest, user: AuthenticatedUser): RaiderRaidProgressResponse {
    ...
    @Transactional
    override fun update(id: Long, request: UpdateRaiderRaidProgressRequest, user: AuthenticatedUser): RaiderRaidProgressResponse {
    ...
    override fun validateAccess(entity: RaiderRaidProgressEntity, user: AuthenticatedUser) {
