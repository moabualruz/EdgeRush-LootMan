...
,
    ...
    @Transactional
    override fun create(request: CreateRaidSignupRequest, user: AuthenticatedUser): RaidSignupResponse {
    ...
    @Transactional
    override fun update(id: Long, request: UpdateRaidSignupRequest, user: AuthenticatedUser): RaidSignupResponse {
    ...
    override fun validateAccess(entity: RaidSignupEntity, user: AuthenticatedUser) {
