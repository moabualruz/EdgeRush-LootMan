...
import com.edgerush.datasync.service.mapper.RaiderMapper
...
class RaiderCrudService(
    ...
    override fun findById(id: Long): RaiderResponse {
        val entity =
            repository.findById(id)
                .orElseThrow { ResourceNotFoundException("Raider not found with id: $id") }
        return mapper.toResponse(entity)
    }

    @Transactional
    override fun create(
        request: CreateRaiderRequest,
    ...
    override fun delete(
        ...
        if (!repository.existsById(id)) {
            throw ResourceNotFoundException("Raider not found with id: $id")
        }
