...
,
    ...
    @Transactional
    override fun create(request: CreateRaidbotsResultRequest, user: AuthenticatedUser): RaidbotsResultResponse {
    ...
    @Transactional
    override fun update(id: Long, request: UpdateRaidbotsResultRequest, user: AuthenticatedUser): RaidbotsResultResponse {
    ...
    override fun validateAccess(entity: RaidbotsResultEntity, user: AuthenticatedUser) {
