...
,
    ...
    @Transactional
    override fun create(request: CreateFlpsGuildModifierRequest, user: AuthenticatedUser): FlpsGuildModifierResponse {
    ...
    @Transactional
    override fun update(id: Long, request: UpdateFlpsGuildModifierRequest, user: AuthenticatedUser): FlpsGuildModifierResponse {
    ...
    override fun validateAccess(entity: FlpsGuildModifierEntity, user: AuthenticatedUser) {
