...
,
    ...
    @Transactional
    override fun create(request: CreateAuditLogRequest, user: AuthenticatedUser): AuditLogResponse {
    ...
    @Transactional
    override fun update(id: Long, request: UpdateAuditLogRequest, user: AuthenticatedUser): AuditLogResponse {
    ...
    override fun validateAccess(entity: AuditLogEntity, user: AuthenticatedUser) {
