...
,
    ...
    @Transactional
    override fun create(request: CreateRaiderStatisticsRequest, user: AuthenticatedUser): RaiderStatisticsResponse {
    ...
    @Transactional
    override fun update(id: Long, request: UpdateRaiderStatisticsRequest, user: AuthenticatedUser): RaiderStatisticsResponse {
    ...
    override fun validateAccess(entity: RaiderStatisticsEntity, user: AuthenticatedUser) {
