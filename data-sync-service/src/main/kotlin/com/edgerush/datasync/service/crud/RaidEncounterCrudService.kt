...
import com.edgerush.datasync.service.mapper.RaidEncounterMapper
...
,
    ...
    @Transactional
    override fun create(request: CreateRaidEncounterRequest, user: AuthenticatedUser): RaidEncounterResponse {
    ...
    @Transactional
    override fun update(id: Long, request: UpdateRaidEncounterRequest, user: AuthenticatedUser): RaidEncounterResponse {
    ...
    override fun validateAccess(entity: RaidEncounterEntity, user: AuthenticatedUser) {
