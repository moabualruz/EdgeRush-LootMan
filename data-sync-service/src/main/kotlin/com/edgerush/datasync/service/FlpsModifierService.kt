...
class FlpsModifierService(
     ...
     */
    fun getModifier(guildId: String, category: String, key: String): Double {
     ...
     */
    fun setGuildModifier(guildId: String, category: String, key: String, value: Double, description: String? = null) {
        ...
        if (existing != null) {
            ...
            // Create new override
            val newModifier = com.edgerush.datasync.entity.FlpsGuildModifierEntity(
                guildId = guildId,
                category = category,
                modifierKey = key,
                modifierValue = BigDecimal.valueOf(value),
     ...
     */
    fun removeGuildModifier(guildId: String, category: String, key: String) {
        val existing = guildModifierRepository.findByGuildIdAndCategoryAndModifierKey(guildId, category, key)
        if (existing != null) {
