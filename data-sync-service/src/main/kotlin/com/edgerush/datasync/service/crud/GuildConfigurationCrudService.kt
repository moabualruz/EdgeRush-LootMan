...
,
    ...
    @Transactional
    override fun create(request: CreateGuildConfigurationRequest, user: AuthenticatedUser): GuildConfigurationResponse {
    ...
    @Transactional
    override fun update(id: Long, request: UpdateGuildConfigurationRequest, user: AuthenticatedUser): GuildConfigurationResponse {
    ...
    override fun validateAccess(entity: GuildConfigurationEntity, user: AuthenticatedUser) {
