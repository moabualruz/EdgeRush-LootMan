...
,
    ...
    @Transactional
    override fun create(request: CreateBehavioralActionRequest, user: AuthenticatedUser): BehavioralActionResponse {
    ...
    @Transactional
    override fun update(id: Long, request: UpdateBehavioralActionRequest, user: AuthenticatedUser): BehavioralActionResponse {
    ...
    override fun validateAccess(entity: BehavioralActionEntity, user: AuthenticatedUser) {
