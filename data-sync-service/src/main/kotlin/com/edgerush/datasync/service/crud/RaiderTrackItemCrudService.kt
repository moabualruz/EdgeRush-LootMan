...
,
    ...
    @Transactional
    override fun create(request: CreateRaiderTrackItemRequest, user: AuthenticatedUser): RaiderTrackItemResponse {
    ...
    @Transactional
    override fun update(id: Long, request: UpdateRaiderTrackItemRequest, user: AuthenticatedUser): RaiderTrackItemResponse {
    ...
    override fun validateAccess(entity: RaiderTrackItemEntity, user: AuthenticatedUser) {
