...
class RaiderDataLoaderTest : UnitTest() {
    ...
    inner class BatchLoad {
        @Test
        fun `should batch load multiple raiders in single query`() =
            runBlocking {
                // Arrange
        ...
        @Test
        fun `should return null for missing raiders`() =
            runBlocking {
                // Arrange
                val raiderIds = listOf(RaiderId(1L), RaiderId(2L), RaiderId(3L))
                val raiders =
        ...
        @Test
        fun `should handle empty id list`() =
            runBlocking {
                // Arrange
        ...
        @Test
        fun `should preserve order of requested ids`() =
            runBlocking {
                // Arrange
