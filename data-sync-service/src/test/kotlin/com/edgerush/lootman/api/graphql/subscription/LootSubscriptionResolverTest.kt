...
class LootSubscriptionResolverTest : UnitTest() {
    ...
    inner class LootAwardedSubscription {
        ...
        @Test
        fun `should receive loot awarded events for guild`() = runBlocking {
            // Arrange
        ...
        fun `should receive multiple events`() = runBlocking {
            ...
            events[0].raiderId shouldBe "1"
            events[1].raiderId shouldBe "2"
            events[2].raiderId shouldBe "3"
        }
    }
    ...
    inner class LootRevokedSubscription {
        ...
        @Test
        fun `should receive loot revoked events for guild`() = runBlocking {
            // Arrange
            val guildId = "guild-123"
        ...
        @Test
        fun `should filter revoked events by guild id`() = runBlocking {
            // Arrange
            val targetGuildId = "guild-123"
            val otherGuildId = "guild-456"
