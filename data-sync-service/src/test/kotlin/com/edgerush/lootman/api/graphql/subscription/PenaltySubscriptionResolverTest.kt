...
class PenaltySubscriptionResolverTest : UnitTest() {
    ...
    inner class PenaltyAppliedSubscription {
        ...
        @Test
        fun `should receive penalty applied events for guild`() = runBlocking {
            // Arrange
            val guildId = "guild-123"
            val event = PenaltyAppliedEvent(
                guildId = guildId,
                raiderId = "raider-42",
                penaltyId = "penalty-1",
    ...
    inner class PenaltyRemovedSubscription {
        ...
        @Test
        fun `should receive penalty removed events for guild`() = runBlocking {
            // Arrange
            val guildId = "guild-123"
        ...
        @Test
        fun `should filter removed events by guild id`() = runBlocking {
            // Arrange
            val targetGuildId = "guild-123"
            val otherGuildId = "guild-456"
    ...
    inner class LootBanAppliedSubscription {
        ...
        @Test
        fun `should receive loot ban applied events for guild`() = runBlocking {
            // Arrange
            val guildId = "guild-123"
        ...
        @Test
        fun `should handle permanent ban with null expiry`() = runBlocking {
            // Arrange
            val guildId = "guild-123"
        ...
        @Test
        fun `should filter loot ban events by guild id`() = runBlocking {
            // Arrange
            val targetGuildId = "guild-123"
            val otherGuildId = "guild-456"
    ...
    inner class LootBanLiftedSubscription {
        ...
        @Test
        fun `should receive loot ban lifted events for guild`() = runBlocking {
            // Arrange
            val guildId = "guild-123"
        ...
        @Test
        fun `should filter lifted events by guild id`() = runBlocking {
            // Arrange
            val targetGuildId = "guild-123"
            val otherGuildId = "guild-456"
    ...
    inner class MultipleEventsFlow {
        ...
        @Test
        fun `should receive multiple penalty events in order`() = runBlocking {
            // Arrange
            val guildId = "guild-123"
