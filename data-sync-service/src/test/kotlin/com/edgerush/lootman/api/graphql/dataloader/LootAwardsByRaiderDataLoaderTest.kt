...
class LootAwardsByRaiderDataLoaderTest : UnitTest() {
    ...
    inner class BatchLoad {
        @Test
        fun `should batch load loot awards for multiple raiders in single query`() =
            runBlocking {
                // Arrange
        ...
        @Test
        fun `should return empty lists for raiders with no awards`() =
            runBlocking {
                // Arrange
        ...
        @Test
        fun `should handle empty raider id list`() =
            runBlocking {
                // Arrange
        ...
        @Test
        fun `should preserve order of requested raider ids`() =
            runBlocking {
                // Arrange
