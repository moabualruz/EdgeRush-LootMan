...
class RaiderGearItemControllerTest : UnitTest() {
    ...
    fun setup() {
        ...
        controller = RaiderGearItemController(service, paginationProperties)
    }
    ...
    inner class CrudTests {
        ...
        fun `should create with 201`() {
            val request = CreateRaiderGearItemRequest(raiderId = 1L, gearSet = "equipped", slot = "head")
        ...
        @Test
        fun `should update`() {
            val request = UpdateRaiderGearItemRequest(itemLevel = 500)
    ...
    inner class FindByRaiderIdAndGearSetTests {
        ...
        fun `should return gear items for raider and gear set`() {
            every { service.findByRaiderIdAndGearSet(1L, "equipped", any()) } returns PagedResponse(listOf(createResponse()), 0, 20, 1)
            controller.findByRaiderIdAndGearSet(1L, "equipped", 0, null).totalElements shouldBe 1
        }
    }
